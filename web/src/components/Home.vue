<template>
  <div>
    <main class="h-100 clr-bg-indigo-500 clr-pal-def-white p-t-5">
      <article class="cont">
      <h1 style="font-weight:normal;" class="txt-sz-3 txt-c">{{title}}</h1>
      <div class="txt-c p-t-3 p-b-3">
        <img :alt="title" src="/static/logo.svg" width=240 />
      </div>
      <p class="txt-j m-b-3 txt-sz-1-2">{{description}}</p>

      <div class="rw m-b-3">
          <div class="cl w-12 txt-c">
            <a :href="systemv" class="clr-pal-def-white m-r-1 txt-sz-2">Редакция systemv</a>
            <a :href="systemd" class="clr-pal-def-white txt-sz-2">Редакция systemd</a>
          </div>
      </div>
